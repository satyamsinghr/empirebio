                        ...
                        <div>
                            ...
                            <div class="section_content h-auto">
                                ...
                                <div
                                    ...
                                    <button
                                        class="btn btn-primary outline-dark py-3 px-4"  onClick={(e) => openModal(e,'reporting')}>Request
                                        a quote</button>
                                    <button
                                        class="btn btn-outline-primary py-3 px-4" onClick={handleDownload}>Schedule
                                        a demo</button>
                                </div>
                            </div>
