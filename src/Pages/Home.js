...
const Home = () => {
  return (
    <div>
        <section className="siteBanner">
            <div className="container">
                <div className="row g-4">
                    <div
                        className="col-lg-5 col-md-12 col-sm-12 col-12 d-flex align-items-center mt-lg-0">
                        <div className="section_content banner_content">
                            <h2 className="mb-lg-4 mb-md-3 mb-3">Beyond the visible
                                spectrum of clean.</h2>
                            <p className="mb-lg-5 mb-md-4 mb-4">We help you ensure
                                every surface in your facility meets the highest
                                standards of cleanliness.</p>
                            <a
                                className="btn btn-outline-primary d-inlien-flex align-items-center gap-3">Here’s
                                how we do
                                it, <svg width="31" height="31"
                    ...
                    <div className="col-lg-7 col-md-12 col-sm-12 col-12 mt-lg-0 d-flex align-items-end">
                        <div className="banner_img">
                            <img src="images/banner_img.png" className="img-fluid"
                                alt />
                        </div>
                    </div>
                </div>
        ...
        <section className="testing_bg d-flex align-items-center">
            <div className="container">
                <div className="row">
                    <div
                        className="col-lg-6 col-md-12 col-sm-12 col-12 offset-lg-6">
                        <div className="beyond_card">
                            <div className="section_content">
                                <h2 className="mb-lg-4 mb-md-3 mb-3">The Crucial
                                    Role of ATP Testing in Healthcare.</h2>
                                <p className="mb-lg-5 mb-md-4 mb-4">ATP testing is
                                ...
                                <div className="row">
                                    <div
                                        ...
                                        <div className="page_card">
                                            ...
                                            <h3 className="mb-1 mt-3">Immediate
                                                Feedback</h3>
                                            <p className="mb-0">Quick results for
                                                prompt action.</p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div className="page_card">
                                            ...
                                            <h3 className="mb-1 mt-3">Evidence-Based
                                                Cleaning</h3>
                                            <p className="mb-0">Data-driven cleaning
                                                protocols.</p>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div className="page_card">
                                            ...
                                            <h3 className="mb-1 mt-3">Comprehensive
                                                Safety</h3>
                                            <p className="mb-0">Ensures environments
        ...
        <section className="cleanliness_bg d-flex align-items-center">
            <div className="container">
                <div className="row">
                    <div
                        className="col-lg-6 col-md-12 col-sm-12 col-12">
                        <div className="section_content banner_content pe-lg-4">
                            <h2
                                className="mb-lg-4 mb-md-3 mb-3 text-white">Cleanliness
                                Confirmed.</h2>
                            <p className="mb-lg-4 mb-md-4 mb-4 text-white">Because
                                “trust me, it’s clean!” doesn’t quiet cut it, in
                                a hospital.</p>

                            <a
                                className="btn btn-outline-primary white_button">Explore
                                CleanRead</a>
        ...
        <section className="feature_products">
            <div className="container">
                <div className="row">
                    <div
                        className="col-lg-7 col-md-8 col-sm-12 col-12 d-flex align-items-center justify-content-lg-start justify-content-md-start justify-content-start">
                        <div className="section_content">
                            <h2 className="m-0">Featured products</h2>
                        </div>
                    </div>
                    <div
                        className="col-lg-5 col-md-4 col-sm-12 col-12 d-flex align-items-center justify-content-lg-end justify-content-md-end justify-content-start">
                        <a className="btn btn-plain">See all products</a>
                    </div>
                </div>
                <div
                    className="row mt-lg-5 mt-md-4 mt-4 pt-lg-2 pt-md-2 g-lg-4 g-md-3 g-3">
                    <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="products_card">
                            <img src="images/feature_img.jpg" className="img-fluid"
                                alt />
                            <div className="products_info">
                                <h3 className="mb-3">CleanRead<sup>™</sup>
                                    Handheld</h3>
                                <a
                                    className="btn btn-outline-primary white_button">Learn
                                    more</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="products_card atp_second">
                            <img src="images/product_pen.png" className="img-fluid"
                                alt />
                            <div className="products_info">
                                <h3 className="mb-3">ATP / Protein Test Swabs</h3>
                                <a
                                    className="btn btn-outline-primary white_button">Learn
                                    more</a>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="products_card">
                            <img src="images/pc.png" className="img-fluid" alt />
                            <div className="products_info">
                                <h3 className="mb-3">CleanRead<sup>™</sup> Reporting
                                    Tool</h3>
                                <a
                                    className="btn btn-outline-primary white_button">Learn
                                    more</a>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-4 col-md-12 col-sm-12 col-12">
                        <div className="banner_content section_content">
                            <h2>About us</h2>
                        </div>
                    </div>
                    <div className="col-lg-8 col-md-12 col-12 col-12">
                        <div className="banner_content section_content">
